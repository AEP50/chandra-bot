...
_REVIEWER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="assigned_reviews_not_complete",
            full_name="chandra_bot_data_model.Reviewer.assigned_reviews_not_complete",
            index=5,
            number=6,
            type=5,
            cpp_type=1,
