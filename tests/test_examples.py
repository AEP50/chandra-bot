...
def test():
    print('Creating bot')
    bot = cbot.create_bot(
    paper_file = os.path.join(example_dir, "data/small_fake_paper_series.csv"),
    review_file = os.path.join(example_dir, "data/small_fake_review_series.csv"),
    human_file = os.path.join(example_dir,"data/small_fake_human.csv")
    )
    ...
    book_file = os.path.join(example_dir, "data/fake_serialized_paper_book.text")
