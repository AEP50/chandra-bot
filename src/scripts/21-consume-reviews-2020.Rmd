---
title: "Consume Reviews for 2020"
output: html_notebook
---

# START HERE
# refactor to just consume the 2021 reviews and decisions and assemble logically
...
papers_file_name <- "ADB40 2020 Papers.xlsx"

decisions_file_name <- "adb40-annual-meeting-2020-decisions.csv"
...
output_reviews_file_name <- paste0(confidential_dir, "confidential-reviews-2020.RDS")
```
