---
title: "Consume Paper Details for 2022"
...
input_dir <- paste0(confidential_dir, "trb-papers/2022/")

google_drive_path <- "~/project_chandra_bhat/papers"

output_file_name <- paste0(confidential_dir, "submitted-paper-author-data-2022")

```

# Fetch from Drive
```{r fetch-from-drive, eval=FALSE}
df <- drive_find(q = "name contains 'TRBAM-22-'", type = "pdf")
...
TODO
Start here. `authors_df` is created, but then not used. Start with `work_authors_df` to see what's going on. Clean this up. 
