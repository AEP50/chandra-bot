---
title: "Consume Reviews for 2019"
...
papers_file_name <- "ADB40 2019 Papers.xlsx"

decisions_file_name <- "adb40-annual-meeting-2019-decisions.csv"
...
output_reviews_file_name <- paste0(confidential_dir, "confidential-reviews-2019.RDS")
```
...
pub_decision_dict_df <- tibble(bot_names = c("ACCEPT",
                               ...
                               editorial_names = c("Completed Accept",
                                                   ...
                                                   "Revise",
                                                   "With Editor"))
recommendation_dict_df <- tibble(review_recommendation = c("Accept: Presentation and Publication",
