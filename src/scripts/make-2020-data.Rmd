...
local_editorial_board_database_file_name <- 
  paste0(confidential_dir, private_editorial_board_database)
local_committee_decisions_file_name <- paste0(confidential_dir, "adb40-annual-meeting-2020-decisions.csv")

output_humans_file_name <- paste0(confidential_dir, "confidential-humans-2020.csv")
output_reviews_file_name <- paste0(confidential_dir, "confidential-reviews-2020.csv")
output_papers_file_name <- paste0(confidential_dir, "confidential-papers-2020.csv")
```
...
output_human_df <- left_join(
  select(working_df, canonical_name, affiliation, orcid_url, last_degree_affiliation, hash),
