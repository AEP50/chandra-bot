...
# START HERE: needed to add missing authors to canonical database. A few with \n\n are still not joining. Figure out problem in the cleansing step in -consume-papers.
...
write_csv(missing_humans_df, "temp.csv")
