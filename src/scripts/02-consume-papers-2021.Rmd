---
title: "Consume Paper Details for 2021"
...
input_dir <- paste0(confidential_dir, "trb-papers/2021/")

google_drive_path <- "~/project_chandra_bhat/papers/"

output_file_name <- paste0(confidential_dir, "submitted-paper-author-data-2021")

```

# Fetch from Drive
```{r fetch-from-drive, eval=FALSE}
df <- drive_find(q = "name contains 'TRBAM-21-'", type = "pdf")
