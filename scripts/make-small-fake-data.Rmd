...
output_paper_file_name <- paste0(processed_dir, "small_fake_paper_series")
output_review_file_name <- paste0(processed_dir, "small_fake_review_series")
output_human_file_name <- paste0(processed_dir, "small_fake_human")
